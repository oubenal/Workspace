...
namespace AnalyzerTests
{
    class Program
    {
        ...
        {
            // TODO: #define the required compilation symbols to run the demos
...
class Person
{
    private int _age;
            ...
            // TODO: use the AnalyzerDriver to execute the FieldNameAnalyzer and print the reported diagnostics
        }
