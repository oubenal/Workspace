...
namespace MoreAnalyzers
{
    ...
    //       As an exercise, change the AnalyzeNode method to allow certain special cases such as
    //
    //           // If statements whose body performs control flow operations a la return or throw.
    //           if (foo == null)
    //               throw new ArgumentNullException("foo");
    //
    //           // Loop constructs with an empty body
    //           while (true)
    //               ;
